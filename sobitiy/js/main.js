//num1 var elem = document.getElementById('element');
// elem.classList.add('www');
// console.log(elem.className);

//num2 var elem = document.getElementById('element');
// elem.classList.remove('a');
// console.log(elem.className);

//num3 var elem = document.getElementById('element');
// console.log(elem.classList.contains('www'))

//num4 var elem = document.getElementById('element');
// elem.classList.toggle('www');
// console.log(elem.className);

//num5 var elem = document.getElementById('element');
// console.log(elem.classList.length)

//num6 var elem = document.getElementsByClassName('www asd qwe');
// let i = 0;
